...
class StockTradingEnv(gym.Env):
    ...
    def _sell_stock(self, index, action):
        def _do_sell_normal():
            if self.state[index+1]>0: 
                ...
                if self.state[index+self.stock_dim+1] !=-1:
    ...
    def _buy_stock(self, index, action):
        ...
        def _do_buy():
            if self.state[index+1]>0 and self.state[index+self.stock_dim+1]!=1: 
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            for index in sell_index:
                ...
                #actions= self._sell_stock(0, actions) * (-1)
            ...
            for index in buy_index:
                ...
                #actions = self._buy_stock(0, actions)
